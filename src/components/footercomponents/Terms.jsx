  ...
  return (
    <div className={stl.wrapper}>
      <div className={stl.modal}>
        ...
        <p>Welcome to turboconverters!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of turboconverters's Website, located at
          https://www.turboconverters.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use turboconverters if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing turboconverters, you agreed
          to use cookies in agreement with the turboconverters's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, turboconverters and/or its licensors own the
          intellectual property rights for all material on turboconverters. All
          intellectual property rights are reserved. You may access this from
          turboconverters for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from turboconverters</li>
          <li>Sell, rent or sub-license material from turboconverters</li>
          <li>Reproduce, duplicate or copy material from turboconverters</li>
          <li>Redistribute content from turboconverters</li>
        </ul>
        ...
        <p>
          ...
          turboconverters does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of turboconverters,its agents and/or affiliates.
          ...
          turboconverters shall not be liable for the Comments or for any
        ...
        <p>
          turboconverters reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant turboconverters a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of turboconverters; and (d) the
        ...
        <p>
          ...
          sending an e-mail to turboconverters. Please include your name, your
        ...
        <p>
          No use of turboconverters's logo or other artwork will be allowed for
